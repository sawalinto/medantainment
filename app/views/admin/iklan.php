<div class="kel">
    ...
    <div class="img">
        <?php $i = 1; ?>
        <div class="video">
            <?php foreach ($data['video'] as $link) : ?>
                <?php if ($i <= 10) { ?>
                    <div class="t-img">
                        <iframe class="iframe" width="315" height="250" src="https://www.youtube.com/embed/<?= $link['link']; ?>"></iframe>
                        <!-- <button class="btn btn-danger"></button> -->
                        <a href="<?= BASEURL ; ?>/admin/hapusIklan/<?= $link['id'] ; ?>" onclick="return confirm('Hapus Video?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Hapus</a>
                    </div>
